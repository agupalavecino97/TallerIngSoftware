...
import static corralon.vistas.ventaConPresupuesto.SeleccionarMaterialesPresupuesto.codigoPedido;
...
public class cantidadMateriales2 extends javax.swing.JPanel {

    
    private DAOManager manager;
   
    public cantidadMateriales2() {
        initComponents();
    ...
    private void aceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarActionPerformed
        try {
            if(saveData()){
                ...
                Long subtotal=cantidad2*precio;
                //pedidoConCantidad pedidoc=new pedidoConCantidad(codigo,nombre,cantidad2,precio);
                pedidoMaterialConNombre pedidoNombre=new pedidoMaterialConNombre(codigo,cantidad2,subtotal,precio,nombre);
...
////                    }
//                }else{
                    pedidoMaterial cosaparainsertar=new pedidoMaterial(codigoPedido,codigo,cantidad2,subtotal);
                    System.out.println(cosaparainsertar);
                    manager.getpedidoMaterialDao().insertar(cosaparainsertar);
                    datosConNombre.add(pedidoNombre);
//                }
                setEditable(false);
                setMaterial(null);
                loadData();
            ...
            Logger.getLogger(cantidadMateriales2.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public boolean buscarEnLista(stock material){
        if(datosConNombre.contains(material)){
            return true;
        }else return false;               
    }
